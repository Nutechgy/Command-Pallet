    ...
    if (userInput.shape === 'square') {
      svgContent = `
        <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200">
          ...
          <text x="50" y="50" font-size="30" fill="${chroma(userInput.textColor)}" dominant-baseline="middle" text-anchor="middle">
        </svg>
      `;
    } else if (userInput.shape === 'circle') {
      svgContent = `2        <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200">
